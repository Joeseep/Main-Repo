...
public class Diseasefragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_diseasefragment, container, false);
        diseaselayout = view.findViewById(R.id.diseaselayout);
        diseaselayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getContext(),category_selection.class);
